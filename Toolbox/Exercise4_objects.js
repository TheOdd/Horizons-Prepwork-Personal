...
console.log("The value stored inside the object is (dot notation_", toolbox.object.something);
...
toolbox.pick = function(object, keysArray) {
  return toolbox.filterKey(object, function () {
...
//  propertyGetter('a') -> 1
//  propertyGetter('b') -> 2
// ex. toolbox.propertyGetter({a: 1})('a') -> 1
